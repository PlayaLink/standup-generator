...
<head>
  ...
  <style>
    ...
    .site { color: #6264A7; font-weight: 600; }
    .instructions {
      margin-top: 24px;
      padding-top: 24px;
...
<body>
  <div class="card">
    ...
    <div class="instructions">
      <p>Return to Teams and type <strong>setup</strong> again to select your board.</p>
    </div>
  </div>
</body>
</html>
...
<body>
  <div class="card">
    ...
    <p style="margin-top: 16px;">Please try again by typing <strong>setup</strong> in Teams.</p>
  </div>
</body>
</html>
  `;
